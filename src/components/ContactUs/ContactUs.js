...
export default function ContactUs() {
  ...
  return (
    <>
      <section class="max-w-[85rem] mx-auto  lg:px-2 mb-[6rem] clsContact  lg:mt-[10px] min-h-[530px]">
        <div class="flex flex-wrap pr-[20px]">
...
<br/>
          ...
          <div class="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full md:w-12/12 lg:w-6/12 px-3 lg:py-2 lg:px-2 md:py-2 md:px-2 md:shadow lg:shadow h-fit">
            <iframe
              title="map"
